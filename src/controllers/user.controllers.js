...
const loginUser = asyncHandler( async (req, res) => {
    ...
    // // if all of them are empty, throw err, since we req something
...
const refreshAccessToken = asyncHandler(async(req, res) => {
    ...
    try {
        // to verify we need to pass token and secret information
...
const updateUserAvatar = asyncHandler(async(req, res) => {
    ...
    return res.status(200)
    .json(
        new ApiResponse(200, user, "Avatar got updated successfully")
    )
...
const updateUserCoverImage = asyncHandler(async(req, res) => {
    ...
    return res.status(200)
    .json(
        new ApiResponse(200, user, "coverImage got updated successfully")
    )
